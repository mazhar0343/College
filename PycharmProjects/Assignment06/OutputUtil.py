...
def write_html_file_new(file_name, my_title, my_tables, open_file=False, style_file=None, do_toc=False):
    if style_file:
    ...
    trailer = create_element(TAG_CENTER, create_element(TAG_H6, f'&copy;2024 • All Rights Reserved • Generated on {dt}'))
